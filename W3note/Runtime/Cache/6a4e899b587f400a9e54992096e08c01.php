    ...
    <div class="leftpage"> <!--leftpage-begin -->
	  ...
	  <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><div class="info"> <!-- info-begin -->
        <div class="postinfo">
          ...
          <div class="title"><strong><a title="<?php echo ($info['title']); ?>" href="<?php echo U('/'.$urlname.'/'.$info['id']);?>"><?php echo ($info['title']); ?></a></strong></div>
		  <div class="tinfo">
        ...
        <div class="tag">tags:<?php echo (webtags($info['keywords'])); ?></div>
        <div class="comnum">评论人数<?php echo (count($info['Comment'])); ?><a href="<?php echo U('/web/'.$info['id']);?>#comment">【我来说两句】</a></div>
      </div>
