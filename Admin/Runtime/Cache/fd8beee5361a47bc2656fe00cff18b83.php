...
<div class="main">
 <div class="tags">
   ...
   <a href="<?php echo U('/Attach/index/',array('module'=>'Page'));?>" >管理附件</a>
   <div class="line"/></div>
</div>
<div class="table-list">
	...
	<td align="center"><a href=""><?php echo ($vo['title']); ?></a></td>
    ...
    <td align="center">
    <?php if($vo['total'] != 0): ?><a href="__APP__/Attach/index/module/Page/id/<?php echo ($vo['id']); ?>" style="color:red;">
    ...
    <a href="__URL__/edit/id/<?php echo ($vo['id']); ?>">修改</a>|
     <?php if($vo['total'] != 0): ?><a href="__APP__/Attach/index/module/Page/id/<?php echo ($vo['id']); ?>">管理附件</a>
       <?php else: ?> 
        <a href="__APP__/Attach/add/module/Page/id/<?php echo ($vo['id']); ?>">添加附件</a><?php endif; ?> 
    </td>	
