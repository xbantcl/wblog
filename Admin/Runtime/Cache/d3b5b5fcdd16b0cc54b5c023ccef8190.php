...
<div class="table-list">
	...
	<td align="center"><a title="<?php echo ($vo['title']); ?>" href="<?php echo (C("rooturl")); ?>web/<?php echo ($vo['id']); ?>.html" target="blank"><?php if(($vo['posid'] == 1)): echo ($vo['title']); ?> <img src="__PUBLIC__/admin/images/small_elite.gif" border="0" alt="推荐" style="cursor : pointer;width:17px;height:16px;" /><?php else: echo ($vo['title']); endif; ?></a></td>
    ...
    <?php if($vo['picnum'] != 0): ?><a href="__APP__/Attach/index/module/News/id/<?php echo ($vo['id']); ?>">管理图片</a>
            <?php else: ?> 
              <a href="__APP__/Attach/add/module/News/id/<?php echo ($vo['id']); ?>">添加图片</a><?php endif; ?> 
    <a href="__APP__/Comment/index/nid/<?php echo ($vo['id']); ?>">评论[<?php echo ($vo['total']); ?>]</a>
    </td>	
