...
<div class="main">
 <div class="tags">
   ...
   <a href="<?php echo U('/Attach/index/',array('module'=>'Download'));?>" >管理附件</a>
   <div class="line"/></div>
</div>
<div id="search">
...
<div class="table-list">
	...
	<td align="center"><?php if(($vo['posid'] == 1)): echo ($vo['title']); ?> <img src="__PUBLIC__/admin/images/small_elite.gif" border="0" alt="推荐" style="cursor : pointer;width:17px;height:16px;" /><?php else: echo ($vo['title']); endif; ?></td>
	...
	<td align="center"><?php echo ($vo['hits']); ?></td>
     <td align="center"><a href="__APP__/Attach/index/module/Download/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['total']); ?></a></td>		
	<td align="center"><?php echo ($vo['username']); ?></td>
	<td align="center"><?php echo (date("Y-m-d H:i:s",$vo['inputtime'])); ?></td>
	<td align="center"> 
     <a href="__URL__/edit/id/<?php echo ($vo['id']); ?>">修改</a>|
       <?php if($vo['total'] != 0): ?><a href="__APP__/Attach/index/module/Download/id/<?php echo ($vo['id']); ?>">管理附件</a>
       <?php else: ?> 
        <a href="__APP__/Attach/add/module/Download/id/<?php echo ($vo['id']); ?>">添加附件</a><?php endif; ?> 
    </td>	
